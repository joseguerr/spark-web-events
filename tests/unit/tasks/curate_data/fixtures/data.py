INPUT_COLS = [
    "distinct_id", "device_id", "referring_domain", "current_url", "device",
    "event_processed_timestamp", "airbyte_emitted_at_timestamp", "_run_date"
]

INPUT_DATA = [
    ["1", "1", "abc.com", "url1", "device1", 1681304876983, 1681304876983, 20230412],
    ["1", "1", "abc.com", "url1", "device1", 1681304876983, 1681304876983, 20230412],  # Duplicate
